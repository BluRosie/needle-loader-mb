...
nullsub_1: @ 0x0201821C
	bx lr
	.align 2, 0

	thumb_func_start sub_2018220
sub_2018220: @ 0x02018220
	push {r4, r5, r6, lr}
...
nullsub_3: @ 0x02018340
	bx lr
	.align 2, 0

	thumb_func_start nullsub_4
nullsub_4: @ 0x02018344
	bx lr
	.align 2, 0

	thumb_func_start sub_2018348
sub_2018348: @ 0x02018348
	push {r4, r5, r6, r7, lr}
	mov r7, r8
	push {r7}
	sub sp, #0x10
